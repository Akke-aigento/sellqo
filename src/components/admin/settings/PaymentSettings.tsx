        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <StripeDisconnectDialog
                ...
                stripeAccountId={status?.account_id || ''}
                ...
                onConfirm={async (confirmedTenantName) => {
                  ...
                  try {
                    const { data, error } = await supabase.functions.invoke('disconnect-stripe-account', {
                      body: { tenant_id: currentTenant?.id, confirmed_tenant_name: confirmedTenantName },
                    });
                    if (error) throw error;
          ...
          <>
            ...
            <div className="space-y-2">
              <p className="text-sm font-medium text-destructive">Gevarenzone</p>
              <p className="text-sm text-muted-foreground">
                Onboarding niet gelukt of verkeerd account? Ontkoppel het Stripe account om opnieuw te beginnen.
              </p>
