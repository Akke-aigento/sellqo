...
const contentTypes = [
  { id: 'product_highlight' as ContentType, name: 'Product Highlight', description: 'Zet een product in de spotlight' },
  { id: 'low_stock_alert' as ContentType, name: 'Laatste Kans', description: 'Urgentie voor bijna uitverkochte items' },
  { id: 'new_arrival' as ContentType, name: 'Nieuwe Collectie', description: 'Kondig nieuwe producten aan' },
  { id: 'seasonal' as ContentType, name: 'Seizoensgebonden', description: 'Passend bij het seizoen of feestdag' },
  { id: 'custom' as ContentType, name: 'Eigen Idee', description: 'Schrijf je eigen prompt' },
];
...
export function SocialPostGenerator() {
  ...
  const [contentType, setContentType] = useState<ContentType>('product_highlight');
