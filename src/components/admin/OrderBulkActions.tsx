...
export function OrderBulkActions({
  ...
  return (
    <>
      <div className="fixed bottom-[var(--admin-nav-offset)] md:bottom-0 left-0 right-0 z-50 border-t bg-background shadow-lg animate-in slide-in-from-bottom-2 lg:left-[var(--sidebar-width,280px)]">
        <Button
          variant="ghost"
          size="icon"
