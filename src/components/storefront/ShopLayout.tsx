        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              {tenant.logo_url ? (
                <img src={tenant.logo_url} alt={tenant.name} className="h-10 mb-4" />
              ) : (
                <h3 
            ...
            {/* Social Links */}
            {themeSettings?.social_links && Object.keys(themeSettings.social_links).length > 0 && (
              <div>
                <h4 className="font-semibold mb-4">Volg Ons</h4>
                <div className="flex gap-3">
                  {themeSettings.social_links.facebook && (
                    <a href={themeSettings.social_links.facebook} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground">
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                  )}
                  {themeSettings.social_links.instagram && (
                    <a href={themeSettings.social_links.instagram} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground">
                  ...
                  {themeSettings.social_links.twitter && (
                    <a href={themeSettings.social_links.twitter} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground">
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    </a>
                  )}
                  {themeSettings.social_links.linkedin && (
                    <a href={themeSettings.social_links.linkedin} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground">
...
function CenteredHeader({ tenant, basePath, categories, navPages, themeSettings }: any) {
  return (
    <div className="py-4">
      ...
      {/* Navigation centered */}
      <nav className="flex items-center justify-center gap-8 border-t pt-4">
