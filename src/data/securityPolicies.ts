...
Security concerns and suspected incidents are reported to a monitored contact address: info@sellqo.app (routed to the Incident Lead). Merchants, partners, end users and security researchers can use this channel. Internal monitoring systems also raise automated alerts to the Incident Lead.
