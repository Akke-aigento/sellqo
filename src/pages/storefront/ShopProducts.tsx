      ...
      <li>
        <button
          ...
          className={`text-sm hover:text-primary transition-colors ${
            !selectedSlug ? 'font-medium text-primary' : 'text-muted-foreground'
          }`}
        >
          Alle producten
        </button>
      ...
      {rootCategories.map(category => (
        <li key={category.id}>
          <button
            ...
            className={`text-sm hover:text-primary transition-colors ${
              selectedSlug === category.slug ? 'font-medium text-primary' : 'text-muted-foreground'
            }`}
          >
            {category.name}
          </button>
              ...
              {categories.filter(c => c.parent_id === category.id).map(sub => (
                <li key={sub.id}>
                  <button
                    ...
                    className={`text-sm hover:text-primary transition-colors ${
                      selectedSlug === sub.slug ? 'font-medium text-primary' : 'text-muted-foreground'
                    }`}
                  >
                    {sub.name}
                  </button>
