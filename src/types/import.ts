...
export const PRODUCT_TARGET_FIELDS = [
  ...
  '_custom_spec_Kleding_closure_type',
  '_custom_spec_Kleding_collar_style',
  '_custom_spec_Kleding_dress_style',
  '_custom_spec_Kleding_embellishment',
  '_custom_spec_Kleding_fabric_type',
  '_custom_spec_Kleding_fit',
  '_custom_spec_Kleding_heel_height',
  '_custom_spec_Kleding_heel_type',
  '_custom_spec_Kleding_length',
  '_custom_spec_Kleding_neckline',
  '_custom_spec_Kleding_occasion',
  '_custom_spec_Kleding_pants_length',
  '_custom_spec_Kleding_pattern',
  '_custom_spec_Kleding_shoe_features',
  '_custom_spec_Kleding_shoe_fit',
  '_custom_spec_Kleding_sleeve_length',
  '_custom_spec_Kleding_sneaker_style',
