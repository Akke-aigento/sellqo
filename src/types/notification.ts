...
export const NOTIFICATION_CONFIG: NotificationCategoryConfig[] = [
  {
    ...
    types: [
      ...
      { type: 'order_payment_failed', label: 'Betaling mislukt', description: 'Wanneer een betaling faalt', defaultInApp: true, defaultEmail: false },
  ...
  },
  {
    ...
    types: [
      ...
      { type: 'campaign_bounce_alert', label: 'Bounce alert', description: 'Veel bounces in campagne', defaultInApp: true, defaultEmail: false },
