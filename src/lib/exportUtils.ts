...
export type ExportFormat = 'csv' | 'xlsx' | 'pdf' | 'intervat-xml' | 'odoo-csv' | 'json';
...
export const commonColumns = {
  ...
  suppliers: [
    ...
    { key: 'vat_number', header: 'BTW-nummer' },
    { key: 'chamber_of_commerce', header: 'KvK-nummer' },
    { key: 'iban', header: 'IBAN' },
    { key: 'payment_terms_days', header: 'Betalingstermijn (dagen)', format: 'number' as const },
    { key: 'is_active', header: 'Actief' },
  ],
  ...
  purchaseOrders: [
    ...
    { key: 'order_date', header: 'Orderdatum', format: 'date' as const },
    { key: 'expected_delivery_date', header: 'Verw. levering', format: 'date' as const },
    { key: 'actual_delivery_date', header: 'Werkelijke levering', format: 'date' as const },
    { key: 'subtotal', header: 'Subtotaal', format: 'currency' as const },
    { key: 'tax_amount', header: 'BTW', format: 'currency' as const },
    { key: 'shipping_cost', header: 'Verzendkosten', format: 'currency' as const },
    { key: 'total', header: 'Totaal', format: 'currency' as const },
  ...
  supplierDocuments: [
    ...
    { key: 'document_date', header: 'Documentdatum', format: 'date' as const },
    { key: 'amount', header: 'Netto', format: 'currency' as const },
    { key: 'tax_amount', header: 'BTW', format: 'currency' as const },
    { key: 'total_amount', header: 'Totaal', format: 'currency' as const },
    { key: 'due_date', header: 'Vervaldatum', format: 'date' as const },
    { key: 'payment_status', header: 'Betaalstatus' },
    { key: 'paid_at', header: 'Betaald op', format: 'date' as const },
  ],
};
