...
export const SHOPIFY_PRODUCT_MAPPING: FieldMapping = {
  ...
  // Clothing & Fashion metafields
  'Accessory size (product.metafields.shopify.accessory-size)': { target: 'raw_import_data', transform: 'jsonString:accessory_size' },
  'Activewear clothing features (product.metafields.shopify.activewear-clothing-features)': { target: 'raw_import_data', transform: 'jsonString:activewear_features' },
  'Activity (product.metafields.shopify.activity)': { target: 'raw_import_data', transform: 'jsonString:activity' },
  'Age group (product.metafields.shopify.age-group)': { target: 'raw_import_data', transform: 'jsonString:age_group' },
  'Bag/Case features (product.metafields.shopify.bag-case-features)': { target: 'raw_import_data', transform: 'jsonString:bag_case_features' },
  'Bag/Case material (product.metafields.shopify.bag-case-material)': { target: 'raw_import_data', transform: 'jsonString:bag_case_material' },
  'Bag/Case storage features (product.metafields.shopify.bag-case-storage-features)': { target: 'raw_import_data', transform: 'jsonString:bag_case_storage' },
  'Care instructions (product.metafields.shopify.care-instructions)': { target: 'raw_import_data', transform: 'jsonString:care_instructions' },
  'Carry options (product.metafields.shopify.carry-options)': { target: 'raw_import_data', transform: 'jsonString:carry_options' },
  'Closure type (product.metafields.shopify.closure-type)': { target: 'raw_import_data', transform: 'jsonString:closure_type' },
  'Clothing accessory material (product.metafields.shopify.clothing-accessory-material)': { target: 'raw_import_data', transform: 'jsonString:clothing_accessory_material' },
  'Clothing features (product.metafields.shopify.clothing-features)': { target: 'raw_import_data', transform: 'jsonString:clothing_features' },
  'Fabric (product.metafields.shopify.fabric)': { target: 'raw_import_data', transform: 'jsonString:fabric' },
  'Fit (product.metafields.shopify.fit)': { target: 'raw_import_data', transform: 'jsonString:fit' },
  'Footwear material (product.metafields.shopify.footwear-material)': { target: 'raw_import_data', transform: 'jsonString:footwear_material' },
  'Headwear features (product.metafields.shopify.headwear-features)': { target: 'raw_import_data', transform: 'jsonString:headwear_features' },
  'Neckline (product.metafields.shopify.neckline)': { target: 'raw_import_data', transform: 'jsonString:neckline' },
  'Outerwear clothing features (product.metafields.shopify.outerwear-clothing-features)': { target: 'raw_import_data', transform: 'jsonString:outerwear_features' },
  'Pants length type (product.metafields.shopify.pants-length-type)': { target: 'raw_import_data', transform: 'jsonString:pants_length' },
  'Shoe features (product.metafields.shopify.shoe-features)': { target: 'raw_import_data', transform: 'jsonString:shoe_features' },
  'Shoe fit (product.metafields.shopify.shoe-fit)': { target: 'raw_import_data', transform: 'jsonString:shoe_fit' },
  'Size (product.metafields.shopify.size)': { target: 'raw_import_data', transform: 'jsonString:size' },
  'Sleeve length type (product.metafields.shopify.sleeve-length-type)': { target: 'raw_import_data', transform: 'jsonString:sleeve_length' },
  'Sneaker style (product.metafields.shopify.sneaker-style)': { target: 'raw_import_data', transform: 'jsonString:sneaker_style' },
  'Target gender (product.metafields.shopify.target-gender)': { target: 'raw_import_data', transform: 'jsonString:target_gender' },
  'Toe style (product.metafields.shopify.toe-style)': { target: 'raw_import_data', transform: 'jsonString:toe_style' },
  'Top length type (product.metafields.shopify.top-length-type)': { target: 'raw_import_data', transform: 'jsonString:top_length' },
  'Waist rise (product.metafields.shopify.waist-rise)': { target: 'raw_import_data', transform: 'jsonString:waist_rise' },
};
