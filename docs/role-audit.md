...
**Bewust ongemoeid / Vervolg** — Bestaande, al gemintte tokens zonder context krijgen geen retro-context (ze vallen op het vangnet terug). Intervallen `weekly`/`quarterly` gebruiken bewust de maand-variant als periode-label; een eigen label kan later additief.
