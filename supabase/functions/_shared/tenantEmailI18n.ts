...
export const TENANT_EMAIL_STRINGS: Record<TenantLocale, Strings> = {
  nl: {
    ...
    invoice: {
      ...
      paidSubject: "Factuur {invoiceNumber} van {tenantName} — voldaan",
      paidIntro: "Beste {customerName}, hierbij ontvang je de factuur voor je aankoop. Deze factuur is voldaan — je hoeft niets meer te doen.",
      paidNote: "De factuur vind je als PDF in de bijlage. Er is geen betaling meer nodig.",
  ...
  en: {
    ...
    invoice: {
      ...
      paidSubject: "Invoice {invoiceNumber} from {tenantName} — paid",
      paidIntro: "Dear {customerName}, please find the invoice for your purchase attached. This invoice has been paid in full — no further action is needed.",
      paidNote: "Your invoice is attached as a PDF. No payment is required.",
  ...
  fr: {
    ...
    invoice: {
      ...
      paidSubject: "Facture {invoiceNumber} de {tenantName} — réglée",
      paidIntro: "Cher/Chère {customerName}, veuillez trouver ci-joint la facture de votre achat. Cette facture est réglée — aucune action n'est requise.",
      paidNote: "La facture est jointe en PDF. Aucun paiement n'est nécessaire.",
  ...
  de: {
    ...
    invoice: {
      ...
      paidSubject: "Rechnung {invoiceNumber} von {tenantName} — bezahlt",
      paidIntro: "Sehr geehrte/r {customerName}, anbei erhalten Sie die Rechnung zu Ihrem Einkauf. Diese Rechnung ist beglichen — es ist keine weitere Aktion erforderlich.",
      paidNote: "Die Rechnung finden Sie als PDF im Anhang. Eine Zahlung ist nicht erforderlich.",
