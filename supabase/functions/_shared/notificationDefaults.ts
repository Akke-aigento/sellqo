...
export const NOTIFICATION_DEFAULTS: Readonly<Record<string, TypeDefaults>> = {
  ...
  "orders/tracking_in_transit": { category: "orders", inApp: true, email: false },
  "orders/tracking_out_for_delivery": { category: "orders", inApp: true, email: false },
  "orders/tracking_delivered": { category: "orders", inApp: true, email: false },
  "orders/tracking_exception": { category: "orders", inApp: true, email: false },
  "orders/return_new_request": { category: "orders", inApp: true, email: false },
  ...
  "invoices/invoice_final_reminder": { category: "invoices", inApp: true, email: false },
  "invoices/invoice_charge_exhausted": { category: "invoices", inApp: true, email: false },
  "invoices/mandate_setup_stalled": { category: "invoices", inApp: true, email: false },
  ...
  "products/product_unmapped": { category: "products", inApp: true, email: false },
  "products/out_of_stock": { category: "products", inApp: true, email: false },
  "quotes/quote_new": { category: "quotes", inApp: false, email: false },
  ...
  "marketing/campaign_high_bounce": { category: "marketing", inApp: true, email: false },
  ...
  "team/team_member_invited": { category: "team", inApp: false, email: false },
  "team/team_member_joined": { category: "team", inApp: true, email: false },
  ...
  "system/ai_credits_low": { category: "system", inApp: true, email: false },
  "system/trial_expiring": { category: "system", inApp: true, email: false },
  "system/trial_expired": { category: "system", inApp: true, email: false },
  "system/admin_announcement": { category: "system", inApp: true, email: false },
  "ai_coach/ai_suggestion": { category: "ai_coach", inApp: true, email: false },
  "ai_coach/ai_coach_suggestion": { category: "ai_coach", inApp: true, email: false },
  ...
  "integrations/shopify_request_received": { category: "integrations", inApp: true, email: false },
  ...
  "integrations/shopify_request_updated": { category: "integrations", inApp: true, email: false },
