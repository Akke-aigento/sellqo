...
function generatePDFHTML(data: {
  ...
  const { invoiceNumber, issueDate, dueDate, currency, tenant, customer, items, subtotal, taxAmount, total, notes } = data;
...
<body>
  ...
  <div class="addresses">
    <div class="address-block">
      ...
      <div><strong>${escapeXml(customerName)}</strong></div>
...
function generateUBL(data: {
  ...
  const { invoiceNumber, issueDate, dueDate, currency, tenant, customer, items, subtotal, taxAmount, total } = data;
