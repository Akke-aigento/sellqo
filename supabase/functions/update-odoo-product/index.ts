...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!product.odoo_product_id) {
      throw new Error('Product is not yet linked to Odoo. Publish first.')
    }
    ...
    console.log(`Updated Odoo product ${odooProductId}`)
    ...
    console.error('Error updating Odoo product:', errorMessage)
